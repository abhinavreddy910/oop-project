...
public class TaskDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        delete_task = findViewById(R.id.delete_or_cancel);
        ...
        if (message.equals("New Task")) {
            i = 0;
            add_or_update.setText("CREATE TASK");
            delete_task.setText("CANCEL");
        } else {
            i = 1;
            add_or_update.setText("UPDATE TASK");
        ...
        add_or_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TaskName.equals("")) {
                    ...
                    Toast.makeText(TaskDetails.this, "Time is not selected", Toast.LENGTH_SHORT).show();
                } else if (Date.equals("")) {
                    Toast.makeText(TaskDetails.this, "Date is not selected", Toast.LENGTH_SHORT).show();
                } else {
                    if (i == 0) {
                    ...
                    Intent intent = new Intent(TaskDetails.this, Meetings.class);
    ...
    private void showDateDialog() {
        ...
        new DatePickerDialog(TaskDetails.this, dateSetListener, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show();
    }
    ...
    private void showTimeDialog() {
        ...
        new TimePickerDialog(TaskDetails.this, timeSetListener, calendar.get(Calendar.HOUR_OF_DAY), calendar.get(Calendar.MINUTE), true).show();
    }
